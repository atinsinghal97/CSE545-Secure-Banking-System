 ...
 */
@Loader(namedQuery = "user_load")
@NamedNativeQuery(name="user_load", query="select user_id, size, username, status, incorrect_attempts, created_date, modified_date, is_external_user from user where id= ?", resultClass = User.class)
