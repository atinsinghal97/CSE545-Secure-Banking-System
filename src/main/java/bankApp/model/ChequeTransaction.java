...
/**
 * The persistent class for the cheque_transaction database table.
 * 
 */
@Entity
@Table(name="cheque_transaction")
@NamedQuery(name="ChequeTransaction.findAll", query="SELECT c FROM ChequeTransaction c")
public class ChequeTransaction implements Serializable {
