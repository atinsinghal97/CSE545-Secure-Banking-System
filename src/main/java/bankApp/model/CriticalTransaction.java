...
/**
 * The persistent class for the critical_transaction database table.
 * 
 */
@Entity
@Table(name="critical_transaction")
@NamedQuery(name="CriticalTransaction.findAll", query="SELECT c FROM CriticalTransaction c")
public class CriticalTransaction implements Serializable {
