...
/**
 * CreditAccountId generated by hbm2java
 */
public class CreditAccountId implements java.io.Serializable {
	...
	public CreditAccountId(int accountId, int userId, String accountNumber, String accountType, Date createdDate,
	...
	public CreditAccountId(int accountId, int userId, String accountNumber, String accountType,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CreditAccountId))
			return false;
		CreditAccountId castOther = (CreditAccountId) other;
