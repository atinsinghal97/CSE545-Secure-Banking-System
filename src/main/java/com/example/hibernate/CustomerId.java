...
public class CustomerId implements java.io.Serializable {
	...
	public CustomerId(int userId, String username, String password, int status) {
		this.userId = userId;
	...
	public CustomerId(int userId, String username, String password, int status, Integer incorrectAttempts,
