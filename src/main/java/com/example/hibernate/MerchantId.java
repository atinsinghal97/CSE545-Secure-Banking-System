...
public class MerchantId implements java.io.Serializable {
	...
	public MerchantId(int userId, String username, String password, int status) {
		this.userId = userId;
	...
	public MerchantId(int userId, String username, String password, int status, Integer incorrectAttempts,
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MerchantId))
			return false;
		MerchantId castOther = (MerchantId) other;
