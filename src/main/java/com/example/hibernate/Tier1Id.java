...
/**
 * Tier1Id generated by hbm2java
 */
public class Tier1Id implements java.io.Serializable {
	...
	public Tier1Id(int userId, String username, String password, int status) {
		this.userId = userId;
	...
	public Tier1Id(int userId, String username, String password, int status, Integer incorrectAttempts,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tier1Id))
			return false;
		Tier1Id castOther = (Tier1Id) other;
