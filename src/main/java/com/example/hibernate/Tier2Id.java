...
/**
 * Tier2Id generated by hbm2java
 */
public class Tier2Id implements java.io.Serializable {
	...
	public Tier2Id(int userId, String username, String password, int status) {
		this.userId = userId;
	...
	public Tier2Id(int userId, String username, String password, int status, Integer incorrectAttempts,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Tier2Id))
			return false;
		Tier2Id castOther = (Tier2Id) other;
