    ...
    <div id="page-content" align="center" class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form:form id="NewPassword" class="form-horizontal" action="/profile/change_password" method="post" modelAttribute="passwordForm">
                    <fieldset>
                    <div><p>${message}</p></div>
          			<form:errors path="isValid" cssClass="error"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <form:password cssClass="form-control" path="oldpassword" id="oldpassword" name="oldpassword" placeholder="Old Password"/>
