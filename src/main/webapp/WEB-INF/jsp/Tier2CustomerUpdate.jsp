		...
		<div class="col-md-12" id="page-content" align="center">
			<div class="panel panel-primary">
  				<div class="panel-heading">
	  			 ...
	  			 <form class="form-horizontal" id="EmployeeUpdateSearch" action="/Tier2/UpdateSearch" method="post">
	  			 <div class="form-group">
					...
					<form class="form-horizontal" id="EmployeeUpdate" action="/Tier2/UpdateValues" method="post">
			  			<fieldset>
			  				<div class="form-group">
