...
<head>
<title>Deposits and Withdrawal</title>
<meta charset="utf-8">
	...
	<div class="container text-center">
		<div class="row">
								...
								<div id="headingOne" class="card-header">
									<h5 class="mb-0">
										<button class="btn btn-link" data-toggle="collapse"
											aria-expanded="false" data-target="#send"
											aria-controls="send">Funds Deposit</button>
									</h5>
								</div>

								<div id="send" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
									<form method="post" action="/paymentactionacc" class="card-body" style="text-align: left;">
										<div class="input-group mb-3">
											<label>Deposit Amount</label>
											<input type="number" class="form-control" min="1" max="${100000}"
												placeholder="Deposit Amount" name="Amount" required="required">
										</div>
										<input name="Deposit" type="hidden" value="choicemade"/>
			...
			<div id="transfer" class="col-sm-4 well">
				<div class="thumbnail"> <p>Brief Statement</p> </div>
				<div class="well"> <p>account1</p> <p>balance</p> <p>date</p> </div>
				<div class="well"> <p>account1</p> <p>balance</p> <p>date</p> </div>
			</div>
		</div>
	</div>
