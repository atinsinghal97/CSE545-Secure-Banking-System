...
<body>
	...
	<div class="container text-center">
		<div id="getter" class="row" >
			<div id="credit" class="col-sm-8" >
				<div class="row">
					<div class="col-sm-12">
							...
							<div class="panel-body">
								...
								<p>
									...
									<li>
										...
										<span>$ ${balance}</span>&nbsp;&nbsp; 
										<span style="float: right;">Placeholder</span>
									</li>
								</p>
							</div>
						</div>
							...
							<div class="col-sm-9">
								<div class="well">
									<p align="left">
										...
										<span>${transaction.date}</span>
										<b style="float: right;"> <span>Status: </span> 
										<span>
												<c:choose>
									...
									<p align="left">
										...
										<span style="float: right;"> <c:choose>
											...
											<c:choose>
												<c:when test="${transaction.payee.accountNumber == accountid && transaction.approvalStatus}">
				...
				<div id="xvg">
					<table>
						<thead>
							<tr>
								<th>From Account</th> <th>To Account</th> <th>Amount</th> <th>Transfer Type</th>
							</tr>
						</thead>
			...
			<div id="transfer" class="col-sm-4 well" >
				<div class="thumbnail">
					<button class="btn btn-success" id="cmd" onclick="return downloader();">Statement Download</button>
				</div>
				<div class="well">
					<p>Account Holder</p>
					<p>${user}</p>
